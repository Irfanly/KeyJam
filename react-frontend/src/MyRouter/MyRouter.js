...
import SingleChordSheetsPage from "../components/app_components/ChordSheetsPage/SingleChordSheetsPage";
import ChordSheetProjectLayoutPage from "../components/app_components/ChordSheetsPage/ChordSheetProjectLayoutPage";
import SingleLessonsPage from "../components/app_components/LessonsPage/SingleLessonsPage";
...
import SongAnalysisList from '../components/keyjam/SongAnalysisList';
//  ~cb-add-import~
...
const MyRouter = (props) => {
    return (
        <Routes>
            ...
            <Route path="/songAnalysis" exact element={<SongAnalysisList />} />
            <Route path="/songAnalysis/create" exact element={<SongAnalysisUpload />} />
