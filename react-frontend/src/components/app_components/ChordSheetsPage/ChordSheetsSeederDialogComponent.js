...
import seederData from "./chordSheets.seeder.json";
...
const ChordSheetsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ChordSheetsSeederDialogComponent);
