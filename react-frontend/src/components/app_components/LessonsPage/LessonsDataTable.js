...
const LessonsDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.youtubeUrl}</p>
...
<Column field="youtubeUrl" header="YoutubeUrl" body={pTemplate2} filter={selectedFilterFields.includes("youtubeUrl")} hidden={selectedHideFields?.includes("youtubeUrl")}  sortable style={{ minWidth: "8rem" }} />
<Column field="content" header="Content" body={pTemplate3} filter={selectedFilterFields.includes("content")} hidden={selectedHideFields?.includes("content")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Lessons Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
          serviceName="lessons"            
          onUploadComplete={() => {
      ...
      <Dialog header="Search Lessons" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default LessonsDataTable;