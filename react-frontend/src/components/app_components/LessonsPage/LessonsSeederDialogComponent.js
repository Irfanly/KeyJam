...
import seederData from "./lessons.seeder.json";
...
const LessonsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LessonsSeederDialogComponent);
