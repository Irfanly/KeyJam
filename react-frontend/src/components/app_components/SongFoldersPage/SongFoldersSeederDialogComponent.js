...
import seederData from "./songFolders.seeder.json";
...
const SongFoldersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SongFoldersSeederDialogComponent);
